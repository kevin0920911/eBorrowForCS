...
<head>
    ...
    <?php // MySQL setup
        ...
        $result = $mysql->query("SELECT beginTime,expireTime,agree,classID  FROM borrow  WHERE userID = '$user->ID'");
        if (!$result) {
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Welcome <?php print $user->name;?></h1>
                    </div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                您的警告次數</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php print $user->warning;?></div>
                                        </div>
                                        <div class="col-auto">
                        ...
                        <div class="col-lg-12 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">公告欄</h6>
                                </div>
                                <div class="card-body">
                                    <ul>
                                        <?php
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">您所借用的教室</h6>
                                </div>
                                <div class="card-body">
                                    <table class="table table-bordered align-middle ">
                                        ...
                                        <?php
                                            for ($i = 0; $i < 10; $i++) {
                                                print "<tr >";
                                                print "<th class='element  col-lg-1 text-center table-dark'>";
                                                if ($i >= 0 && $i < 4) {
                                                    print $i + 1;
                                                } else if ($i == 4) {
                                                    print "A";
                                                ...
                                                // 2 for has reserved
                                                for ($j = 0; $j < 5; $j++) {
                                                    $class = $classTable[$i][$j];
                                                    $return_value = match ($userTable[$i][$j]) {
                                                        0 => "<td class='element col-lg-2 text-center highlight'></td>",
                                                        1 => "<td class='element  col-lg-2 text-center col-lg-2 text-center table-danger' > <small>$class <br>正在使用</small></td>",
                                                        2 => "<td class='element  col-lg-2 text-center  table-warning'> <small>$class<br>已經預約</small> </td>",
                                                    };
                                                    print $return_value;
                                                }
                                                print "</tr>";
