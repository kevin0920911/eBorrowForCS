...
<?php
    ...
    $announcementToEdit = $announcements[$indexToEdit];
    /* for bulletin edit */
?>
<!DOCTYPE html>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">修改公告</h1>
                    </div>                    

                    <div class="row mt-4">
                        <div class="col-lg-12 mb-4">
                            <form method="POST" action="bulletin_manage.php">
                                <input type="hidden" name="edit_index" value="<?php echo $indexToEdit; ?>">
                                <div class="form-group">
                                    <input type="text" name="edited_announcement" value="<?php echo $announcementToEdit; ?>" required class="form-control" >
                                </div>
                                <button type="submit" name="edit_announcement" class="btn btn-primary">儲存修改</button>                                        
                            </form>
                        </div>
                    </div>
                </div>
