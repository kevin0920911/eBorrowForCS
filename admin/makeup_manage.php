            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">愛系服務管理</h1>
                    </div>

                    <!-- Content Row -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">愛系名單</h6>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            // 開啟MySQL的資料庫連接
                                            $link = @mysqli_connect("localhost", "root", "123456") or die("無法開啟MySQL資料庫連接!<br/>");
                                            mysqli_select_db($link, "ncyucsie"); // 選擇myschool資料庫
                                            // 執行SQL查詢
                                            ...
                                            if (mysqli_errno($link) != 0) {
                                                ...
                                                while ($row = $result->fetch_assoc()) {
                                                    print "<tr>";
                                                    if($row['usertype'] == 'one') print "<td>"."大一"."</td>";
                                                    else if($row['usertype'] == 'two') print "<td>"."大二"."</td>";
                                                    else if($row['usertype'] == 'three') print "<td>"."大三"."</td>";
                                                    else print "<td>"."大四"."</td>";
                                                    echo '<label for="exampleDateTimePicker">選擇日期與時間</label>
                                                          <input type="datetime-local" class="form-control" id="exampleDateTimePicker">';
                                                    print "<td>".$row['serviceTime']."</td>";
                                                    ...
                                                    echo "<a href=\"timeSet.php?usertype=$usertype&serviceTime=$serviceTime\" class=\"btn btn-warning btn-icon-split btn-sm\">" .
                                                        "<span class=\"icon text-white-50\">" .
                                                        "<i class=\"fas fa-exclamation-triangle\"></i>" .
                                                        "</span>" .
                                                        "<span class=\"text\">儲存變更時間</span>" .
                                                        "</a>";
                                                    echo "  ";
                                                    echo "<a href=\"deleteForService.php?usertype=$usertype&serviceTime=$serviceTime\" class=\"btn btn-danger btn-icon-split btn-sm\">" .
                                                        "<span class=\"icon text-white-50\">" .
            ...
            <script>
                for (const a of document.querySelectorAll('a')) {
                    ...
                    a.addEventListener("mousedown", e => {
                        const picker = document.querySelector('#exampleDateTimePicker');
                        if(picker.value) a.href = `timeSet.php?usertype=<?= $usertype ?>&serviceTime=${picker.value}`;
                        // alert(a.href);
                    })
                }
            </script>
