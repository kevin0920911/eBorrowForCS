                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3 ">
                                    <div class='row justify-content-center align-items-center'>
                                        <h6 class="col-5 m-0 font-weight-bold text-primary">公告欄</h6>
                                        <a href='bulletin_manage.php' class='col-2 btn btn-primary btn-sm ml-auto'>
                                            <span class='icon text-white-50'>
                                                <i class="fas fa-bullhorn"></i>
                                            </span>
                                            <span class='text'>更改/新增</span>
                                        </a>
                                    </div>
                                </div>
                                <div class="card-body">
