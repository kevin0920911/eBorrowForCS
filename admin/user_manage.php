...
<?php
    ...
    if ( isset($_POST['new']) ) {
        ...
        $sql = "INSERT INTO user (`userID`, `Account`, `usertype`, `name`, `warn`, `password`) VALUES ('$userID', '$Account', '$usertype', '$name', '$warn', '$password')";
        $check = $mysql->query("SELECT * FROM user WHERE userID = '$userID'");    
        if($check->num_rows == 0) {
    ...
    if (isset($_POST['modify'])) {
        ...
        $mysql->select_db("ncyucsie");
        $sql = "UPDATE user SET Account='$Account', usertype='$usertype', name='$name', warn='$warn', password='$password' WHERE userID='$userID' ";
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">使用者管理</h1>
                    <p class="mb-4">修改及刪除功能請小心使用</p>
                                        ...
                                        <?php
                                            ...
                                            while ($rows = $result->fetch_assoc()) {
                                                print "<tr>";                                          
                                                    ...
                                                    print "<td>" . $rows["userID"] . "</td>";
                                                    print "<td>" . $rows["Account"] . "</td>";
                                                    ...
                                                    print "<td>" . $rows["warn"] . "</td>";
                                                    print "<td>" . $rows["password"] . "</td>";
                                                
                                                print "<td>";

                                                printModifyButton($rows["userID"]);
                                                print " ";
                                                printDeleteButton($rows["userID"]);
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">新增使用者</h6>
                        </div>
                        <div class="card-body">
                            <form method="POST" action="user_manage.php">
                                ...
                                <div class="form-group row">
                                    <label for="userID" class="col-sm-2 col-form-label">使用者ID(不可重複)</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="userID" name="userID" maxlength="7">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label for="usertype" class="col-sm-2 col-form-label">類型</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="name" name="name" maxlength="5">
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <label for="warn" class="col-sm-2 col-form-label">警告次數</label>
                                    <div class="col-sm-10">
